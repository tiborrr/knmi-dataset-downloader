...
class WithFilenameItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/datasets/{datasetName}/versions/{versionId}/files/{filename}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/datasets/{datasetName}/versions/{versionId}/files/{filename}", path_parameters)
